        ...
        <div>
            <form action="{{ route('users.update',$user) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mx-3">
                    ...
                    <div class="col-5">
                        <img src="{{ $user->images ? asset('upload/users/'.$user->images->url):'upload/users/1696572457lop6.jpg'}}" class="img-thumbnail" id="show-image" width="200px" alt="">
                    </div>
                </div>
                ...
                <div class="input-group mx-3 mb-3">
                    ...
                    <select class="form-select" name="gender" id="inputGroupSelect01" value="{{$user->gender}}">
